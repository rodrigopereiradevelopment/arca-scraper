...
class SaoVicenteScraper(BaseScraper):
    def __init__(self):
        ...
        # Número de threads paralelas — aumenta se não houver bloqueios
        self.max_workers = 5
        # Delay entre requisições por thread (segundos)
        self.delay = 0.5
        ...
        for i in range(tentativas):
            try:
                ...
                if res.status_code == 200:
                    ...
                    # Rate limit — espera mais antes de tentar de novo
                    wait = 5 * (i + 1)
    ...
    def buscar_produto_com_cat(self, args):
        """Wrapper para uso no ThreadPoolExecutor — retorna (pid, produto, historico)."""
        pid, nome_cat = args
        time.sleep(self.delay)  # delay por thread pra não sobrecarregar
    ...
    def executar(self):
        ...
        for nome_cat, cgid in self.categorias.items():
            ...
            while start < total:
                ...
                # Monta lista de tarefas (pid, nome_cat) pra executar em paralelo
                ...
                with ThreadPoolExecutor(max_workers=self.max_workers) as executor:
                    ...
                    for future in as_completed(futures):
                        ...
                        pid, produto, historico = resultado
