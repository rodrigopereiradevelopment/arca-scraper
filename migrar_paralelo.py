...
def migrar_produto(produto):
    """Migra UM produto para o novo formato"""
    try:
...
# Buscar produtos que ainda não têm histórico
...
for i in range(0, total_pendentes, BATCH_SIZE):
    ...
    with ThreadPoolExecutor(max_workers=MAX_WORKERS) as executor:
        futures = {executor.submit(migrar_produto, produto): produto for produto in batch}
